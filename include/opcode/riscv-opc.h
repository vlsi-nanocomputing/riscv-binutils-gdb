...
#define MASK_SW_ACTIVE_AND  0x707f
#define MATCH_SW_ACTIVE_XOR 0x103b
#define MASK_SW_ACTIVE_XOR  0x707f
#define MATCH_SW_ACTIVE_NONE 0x3b
#define MASK_SW_ACTIVE_NONE  0x707f
#define MATCH_SW_ACTIVE_MIN 0x503b
#define MASK_SW_ACTIVE_MIN  0x707f
#define MATCH_SW_ACTIVE_MAX 0x603b
#define MASK_SW_ACTIVE_MAX  0x707f
#define MATCH_LW_MASK_AND 0x201b
#define MASK_LW_MASK_AND  0x707f
#define MATCH_LW_OR 0x301b
#define MASK_LW_OR  0x707f
#define MATCH_LW_XOR 0x101b
#define MASK_LW_XOR  0x707f
#define MATCH_LW_MIN 0x501b
#define MASK_LW_MIN  0x707f
#define MATCH_LW_MAX 0x601b
#define MASK_LW_MAX  0x707f
...
DECLARE_INSN(lw_mask_and, MATCH_LW_MASK_AND, MASK_LW_MASK_AND)
DECLARE_INSN(lw_or, MATCH_LW_OR, MASK_LW_OR)
DECLARE_INSN(lw_xor, MATCH_LW_XOR, MASK_LW_XOR)
DECLARE_INSN(lw_min, MATCH_LW_MIN, MASK_LW_MIN)
DECLARE_INSN(lw_max, MATCH_LW_MAX, MASK_LW_MAX)
